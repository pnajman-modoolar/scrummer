...
class ProjectAgileBoard(models.Model):
    ...
    kanban_initial_column_stage_ids = fields.One2many(
        ...
        compute="compute_kanban_initial_column_stage_ids",
        scrummer=True,
    )
    ...
    def compute_kanban_initial_column_stage_ids(self):
        self.kanban_initial_column_stage_ids = \
            self.mapped("kanban_initial_column_status_ids.stage_id")
